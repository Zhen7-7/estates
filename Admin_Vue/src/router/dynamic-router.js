...
const routes=[
  ...
  },
  {
    ...
    children:[
      ...
      //   path: '/news/add',
      //   name: 'news-add',
      //   // component: (resolve) => require(['@/pages/news/NewsAdd'], resolve),
      //   component: () => import("@/pages/news/NewsAdd"),
      //   // meta:{requiresAuth:true,keepAlive:true},
      // },
      {
        path: '/rob/index',
        component: (resolve) => require(['@/pages/rob/RobIndex'], resolve),
        meta:{requiresAuth:true},
      },
      {
        path: '/rob/edit',
        component: (resolve) => require(['@/pages/rob/RobEdit'], resolve),
        meta:{requiresAuth:true},
      },
