...
Page({
 ...
 this.data.days.push({wook:i,src:i <= getDate?'../../icons/2.png':''});
 }else if(this.data.opentime[1] == month && month == this.data.shuttime[1]){
 if((this.data.opentime[2] <= i) && (i <= this.data.shuttime[2])){
  this.data.days.push({wook:i,src:'../../icons/2.png'});
 }else{
  this.data.days.push({wook:i,src:''});
 }
 }else if(this.data.opentime[1] == month && month < this.data.shuttime[1]){
 this.data.days.push({wook:i,src:this.data.opentime[2] <= i?'../../icons/2.png':''});
 }else if(this.data.opentime[1] < month && month < this.data.shuttime[1]){
 this.data.days.push({wook:i,src:'../../icons/2.png'});
 }else{
 this.data.days.push({wook:i,src:''});
 ...
 if(ornot == 0){
  if(0 <= (obinl - i)){
  that.data.day[obinl - i].src = "../../icons/2.png"
  }
 }else{
  if(0 <= (obinl - i - 1)){
  that.data.day[obinl - i - 1].src = "../../icons/2.png"
  }
 }
 }else{
 return false
