...
Page({
  ...
  doGetCode(e) {
    ...
    //   // else if (!/^1[3|4|5|8][0-9]\d{8}$/.test(this.data.phone)) {
    //   wx.showToast({
    //     title: '手机号格式错误',
    //     icon: 'error',
    //     duration: 2000
    //   })
    //   return
    // } else if (!/^[\u4E00-\u9FA5]{2,10}/.test(this.data.realname)){
    //   wx.showToast({
    //     title: '真实姓名错误',
    //     icon: 'error',
    //     duration: 2000
    //   })
    //   return
    // }else if (!/^\d{17}(\d|x)$/.test(this.data.identity)) {
    //   wx.showToast({
    //     title: '身份证格式错误',
    //     icon: 'error',
    //     duration: 2000
    ...
    //   })
    //   return
    // } else if (!/^[\u4E00-\u9FA5]{2,10}/.test(this.data.address)) {
    //   wx.showToast({
    //     title: '地址格式错误',
    //     icon: 'error',
    //     duration: 2000
